 ...
 * top-level page with no opener. Property access is wrapped in try/catch as a
 * defensive measure against exotic cross-origin environments.
 */
export const detectChildTarget = (win: Window = window): Window | null => {
    try {
